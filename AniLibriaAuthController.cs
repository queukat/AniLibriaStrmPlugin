...
public class AniLibriaAuthController : ControllerBase
{
    ...
    /// <summary>
    ///     (A) Логин через mail+passwd (сохраняет sessionId в плагин-конфиг).
    /// </summary>
    ...
    public async Task<object> SignInLoginPass([FromBody] LoginRequest req)
    {
        ...
        // Если не нашли sessionId в JSON, ищем в куках
        ...
        // А вот теперь можно логировать значение sessionId:
    ...
    // Пример OTP-функций (если захотите пользоваться)
    [HttpPost("StartOtp")]
